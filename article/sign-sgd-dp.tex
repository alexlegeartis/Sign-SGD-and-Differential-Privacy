...
\paragraph{Idea:} We add Gaussian noise and privacy amplification by subsampling to make sign-SGD private.
...
According to ??? from \cite{Mironov2017}, advanced composition theorems for $(\eps, \delta)$-privacy are unlikely to yield strong bounds.
...
\subsection{Constructing \scriptsize{DP-SIGN}}
